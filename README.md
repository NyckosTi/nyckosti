### Sobre mim
🔐 Como um pesquisador de segurança cibernética baseado na Tunísia, estou profundamente imerso nos reinos da defesa e exploração digital. Minha paixão atual está em dominar a arte do Sandbox com Rust, enquanto também me aprofundo nas complexidades do Exploit Development e Networking.

🌍 Estou sempre aberto a colaborar em Pesquisas de Segurança Cibernética de ponta, com foco especial em produtos VMware. Atualmente, também estou em busca de insights sobre SEO e gerenciamento de tráfego para ampliar o alcance do meu blog instigante, InfoSec OpenMic .

💬 Sinta-se à vontade para me envolver em discussões que vão desde estratégias de Segurança Cibernética até as nuances da Administração de Sistemas e Redes. Seja protegendo sistemas ou criando aplicativos robustos usando o MERN Stack, estou aqui para compartilhar insights e explorar novas ideias.

📄 Currículo : Veja meu currículo

📝 (EM BREVE) Curioso sobre minhas últimas descobertas? Confira meus artigos no InfoSec OpenMic , onde decifro conceitos complexos de segurança em insights digeríveis.
